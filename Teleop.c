...
#pragma config(Servo,  srvo_S1_C4_2,    ballContainer,        tServoStandard)
#pragma config(Servo,  srvo_S1_C4_3,    grabberRight,         tServoStandard)
#pragma config(Servo,  srvo_S1_C4_4,    grabberSide,          tServoStandard)
#pragma config(Servo,  srvo_S1_C4_5,    center,               tServoStandard)
...
void initializeRobot() {
	servo[ballContainer] = 150; // higher is lower
...
task main() {
	...
	while (true) {
		...
		if(joystick.joy2_y1 > 30 || joystick.joy2_y1 < -30) {
			if(joystick.joy2_y1 >= 70) { // && rightServoPos == 0 && leftServoPos == 0
				motor[leftFront] = 70;
				motor[leftBack] = 70;
				...
				motor[leftFront] = joystick.joy2_y1;
				motor[leftBack] = joystick.joy2_y1;
			}
		}
		if(joystick.joy2_y2 > 30 || joystick.joy2_y2 < -30) {
			if(joystick.joy1_y2 >= 70) {
				...
				motor[rightFront] = joystick.joy2_y2;
				motor[rightBack] = joystick.joy2_y2;
			}
		}
		wait1Msec(100);
	}
